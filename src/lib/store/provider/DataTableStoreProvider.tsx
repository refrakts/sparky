...
export interface DataTableStoreProviderProps<T extends Record<string, unknown>> {
    /**
...
export function DataTableStoreProvider<T extends Record<string, unknown>>({
    ...
    return (
        <StoreContext.Provider value={value as StoreContextValue<Record<string, unknown>>}>
            {children}
